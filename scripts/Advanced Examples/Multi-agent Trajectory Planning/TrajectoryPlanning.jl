...
function create_readme(output_dir, logger)
    ...
    open(readme_file, "w") do f
        ...
        println(f, "- `convergence.png` - Convergence plot of the inference")
        println(f, "")
        println(f, "### Data Files")
        println(f, "- `paths.csv` - Raw path data")
        println(f, "- `controls.csv` - Raw control signals")
        println(f, "- `uncertainties.csv` - Path uncertainties")
        println(f, "- `convergence_metrics.csv` - ELBO values during inference")
        println(f, "- `experiment.log` - Detailed log of the experiment")
        println(f, "- `experiment_summary.txt` - Summary of experiment results")
        println(f, "")
