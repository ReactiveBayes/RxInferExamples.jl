...
# Set GR backend with explicit display setting
ENV["GKSwstype"] = "100"
gr()
...
println("Setting up agent definitions...")
...
println("Defining planning model...")
...
function execute_and_save_animation(environment, agents; gifname = "result.gif", kwargs...)
    ...
    println("Saving animation to $gifname...")
...
println("Defining agent configurations...")
