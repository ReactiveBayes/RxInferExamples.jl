# Multi-agent Trajectory Planning: Visualization Guide
...
```julia
animate_control_signals(agents, controls, paths; 
...
```julia
animate_path_uncertainties(environment, agents, paths, path_vars; 
                          filename = "path_uncertainties.gif", 
                          fps = 15,
                          x_limits = (-20, 20), 
                          y_limits = (-20, 20), 
                          plot_size = (800, 400),
...
**Parameters:**
- `environment`, `agents`, `paths`: Similar to animate_paths
- `path_vars`: Matrix of variances in agent positions, dimensions: (nr_agents, nr_steps)
...
- Other parameters similar to animate_paths
...
```julia
animate_combined_visualization(environment, agents, paths, controls, path_vars; 
...
**Parameters:**
- `environment`, `agents`, `paths`, `controls`, `path_vars`: As in previous functions
...
**Parameters:**
- Similar to animate_path_uncertainties, but produces a static image
